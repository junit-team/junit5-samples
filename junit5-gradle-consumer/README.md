...
buildscript {
	...
	dependencies {
		classpath 'org.junit.platform:junit-platform-gradle-plugin:1.0.0-RC1'
	}
}
...
```groovy
dependencies {
	testCompile("org.junit.jupiter:junit-jupiter-api:5.0.0-RC1")
	testRuntime("org.junit.jupiter:junit-jupiter-engine:5.0.0-RC1")
}
```
...
dependencies {
	...
	testRuntime("org.junit.vintage:junit-vintage-engine:4.12.0-RC1")
}
```
